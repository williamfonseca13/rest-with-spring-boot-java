...
class DozerMapperTest {
    ...
    void parseEntityToDtoTest() {
        PersonDto output = DozerMapper.parseObject(input.mockEntity(), PersonDto.class);
    ...
    void parseEntityListToDtoListTest() {
        ...
        List<PersonDto> outputList = DozerMapper.parseListObjects(input.mockEntityList(), PersonDto.class);
    ...
    void parserDtoListToEntityListTest() {
        List<Person> outputList = DozerMapper.parseListObjects(input.mockVOList(), Person.class);
